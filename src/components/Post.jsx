...
function Post({postProp, id, account, withCommentAccordion = true, fetchAccount, setPostsArr, setToast}){
    ...
    const publicSharedContentRef = useRef();
    const privateSharedContentRef = useRef();
    ...
    const updatePostRequest = ()=>{
        let html = sanitizeHtml(postContentRef.current.innerHTML, defaultSanitizeOptions);
    ...
    const sharePostRequest = (isVisibleToFollowers, friendsVisibility, isPublic)=>{
        const friendsArr = [];
        let selectedCnt = 0;
        ...
        const friendsVisibilityType = friendsVisibility || (selectedCnt<friendsArr.length);
        ...
        const content = isPublic?
            ...
            sanitizeHtml(privateSharedContentRef.current.innerHTML,defaultSanitizeOptions)
                    ...
                    fetch(import.meta.env.VITE_REFRESH_TOKEN,{
                        ...
                        .then(async (res)=>{
                            if(res.status === 200){
                                const data = await res.json();
                                setAccessToken(data.access_token);
                                sharePostRequest(isVisibleToFollowers, friendsVisibility, isPublic);
                            }
                            else{
                                removeCookie("refresh_token");
                                removeCookie("JSESSIONID");
    ...
    const newCommentRequest = ()=>{
        ...
        const content = sanitizeHtml(commentContentRef.current.innerHTML,defaultSanitizeOptions);
    ...
    return (
        <div className=" px-4 py-4 bg-white rounded-lg shadow-md dark:bg-gray-800 flex flex-col mt-4 hs-accordion">
            ...
            <div className="mt-2 text-gray-300">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Tempora
                expedita dicta
            </div>
            ...
            <hr className="border-gray-200 dark:border-gray-700 mt-4"/>
                ...
                <div className="flex mt-2 items-center justify-between mb-2 hs-accordion-group">
                    ...
                    <p className="hs-accordion-toggle text-white">
                        10 Comments
                    </p>
                ...
                <div className="mb-2">
                    ...
                    <div className="flex mt-2">
                        ...
                        <button
                            className="px-3 py-2 mx-1 mt-2 text-gray-700 transition-colors duration-300 transform rounded-md lg:mt-0 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 flex-1 hs-accordion-toggle">Comment
                        </button>
                    </div>
                ...
                <div className={"overflow-hidden transition-[height] duration-300 hidden hs-accordion-content"}>
